...
Retail_Price_and_Dates_Week <- Retail_Price_and_Dates[, Mean_Retail_Price:=mean(Retail.Price), by = floor_date(Date,unit = "week")]

colnames(Retail_Price_and_Dates_Week)[2] <- "Mean_Retail_Price"

Retail_Price_and_Dates_Day <- Retail_Price_and_Dates[, Mean_Retail_Price:=mean(Retail.Price), by = floor_date(Date,unit = "day")]
