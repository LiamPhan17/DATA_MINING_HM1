...
map_1 <- leaflet() %>% addTiles() %>% addMarkers(data=Data_Client_Coordinates, lng = ~Data_Client_Coordinates$customer.X, lat = ~Data_Client_Coordinates$customer.Y, clusterOptions = markerClusterOptions())
