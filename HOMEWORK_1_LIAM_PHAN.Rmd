...
ggplot(Sales_Stores_Revenues) +
 aes(x = Store.Postcode, y = Configuration, fill = Percentage_Revenue) +
 geom_violin(adjust = 1L, scale = "area") +
 scale_fill_distiller(palette = "Greens", direction = 1) +
 labs(x = "Stores", title = "Violinplots of Configuration amonst Stores", subtitle = "In 2018", fill = "% Total Revenues") +
 theme_classic()+theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
)
...
> We can see the % Total Revenues from each stores, while seeing the configurations they propose.
