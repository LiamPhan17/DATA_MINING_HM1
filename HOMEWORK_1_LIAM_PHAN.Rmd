...
ggplot(Sales_Stores_Revenues) +
 ...
 size = 2.45) +
 scale_color_hue(direction = 1) +
 labs(x = "Sales Volumes", y = "Revenues", title = "ScatterPlot Of Sales Volumes VS Revenues per Store", 
 subtitle = "In 2018")
 theme_minimal()
...
ggplot(Sales_Stores_Revenues_Configuration) +
 ...
 geom_point(shape = "circle", size = 2.95) +
 scale_color_gradient() +
 labs(x = "Sales Volume", y = "Sales Revenues", 
 title = "Scatterplot Of Sales Volumes VS Sales Revenues (Regarding Configurations)", subtitle = "In 2018") +
 theme_minimal()
