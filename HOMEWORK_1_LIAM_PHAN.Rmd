...
RetailPricePlot1 <- ggplotly(
 ...
 labs(x = "Months", y = "Average Retail Price", title = "Average Retail Price of Computer in 2018 - Aggregated by Month", 
...
RetailPricePlot2 <- ggplotly(
 ...
 geom_line(size = 0.4, 
 colour = "#1c6155") + geom_point() +
 labs(x = "Weeks", y = "Average Retail Price", title = "Average Retail Price of Computer in 2018 - Aggregated by Weeks", 
...
RetailPricePlot3 <- ggplotly(
 ...
 geom_line(size = 0.2, 
 colour = "#1c6155")  +
 labs(x = "Days", y = "Average Retail Price", title = "Average Retail Price of Computer in 2018 - Aggregated by Days", 
